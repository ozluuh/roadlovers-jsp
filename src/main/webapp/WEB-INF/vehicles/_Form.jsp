...
<div class="mb-2">
    ...
    <div class="form-group">
        ...
        <input
        	...
        	id="Model"
        	class="form-control"
        	placeholder="Informe o modelo do ve�culo..."
        	value="${vehicle.model}"
        	required
        />
    </div>
    ...
    <div class="form-group">
        ...
        <input
        	...
        	min="1920"
        	max="9999"
        	placeholder="Informe o ano do ve�culo..."
        	value="${vehicle.year}"
        />
    </div>
    ...
    <div class="form-group">
        ...
        <input
            ...
            id="Manufacturer"
            class="form-control"
            placeholder="Informe a fabricante do ve�culo..."
            list="manufacturers"
    ...
    <div class="form-group">
        ...
        <input
        	...
        	id="VehicleType"
        	class="form-control"
        	placeholder="Informe a classe do ve�culo..."
    ...
    <div class="form-group">
        ...
        <input
        	...
        	step="any"
        	min="1"
        	placeholder="Informe o valor do ve�culo..."
        	pattern="^\d+(\.|,)?\d{2}$"
        	value="${vehicle.value}"
        	required
        />
